...
multichaind testchain@10.244.48.74:1000 --rpcthreads=1024 --datadir=/home/admin1/multichain-caliper/node-data --port=1000 --rpcport=999 --blocknotify="/home/admin1/multichain-caliper/server/event-listener-websockets/script.sh %s"